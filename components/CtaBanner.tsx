      ...
      <div className="relative overflow-hidden rounded-2xl bg-ink-900 px-6 py-10 text-white md:px-12 md:py-14">
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row md:col-span-2 md:flex-col md:items-stretch lg:flex-row lg:justify-end">
            <a
              href={waLink("Merhaba, web sitenizden ulaşıyorum, konteynerler hakkında bilgi almak istiyorum.")}
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex flex-1 items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-xl bg-[#128C7E] px-4 py-3 sm:px-6 sm:py-3.5 sm:gap-2.5 text-sm sm:text-base font-bold text-white shadow-lg shadow-[#128C7E]/20 ring-1 ring-white/10 transition-all hover:scale-[1.02] hover:bg-[#075E54] hover:shadow-[#128C7E]/40 active:scale-[0.98] sm:flex-none md:px-8 md:text-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#128C7E] focus-visible:ring-offset-2"
            >
              <span className="grid h-6 w-6 sm:h-8 sm:w-8 shrink-0 place-items-center rounded-full bg-white/20">
