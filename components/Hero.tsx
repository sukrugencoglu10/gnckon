        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row sm:flex-wrap">
            <a
              ...
              className="group relative inline-flex items-center justify-center gap-2 overflow-hidden whitespace-nowrap rounded-xl bg-wa px-5 py-3.5 text-base sm:gap-2.5 sm:px-8 sm:py-4 sm:text-lg font-bold text-white shadow-lg shadow-wa/30 ring-1 ring-white/10 transition hover:-translate-y-0.5 hover:bg-wa-dark hover:shadow-xl hover:shadow-wa/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wa focus-visible:ring-offset-2 focus-visible:ring-offset-ink-900"
            >
              <span aria-hidden className="grid h-7 w-7 sm:h-8 sm:w-8 shrink-0 place-items-center rounded-full bg-white/20">
                <svg viewBox="0 0 24 24" className="h-4 w-4 sm:h-5 sm:w-5 fill-current" aria-hidden>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-white/20 bg-white/10 px-5 py-3.5 text-base sm:px-6 sm:py-4 sm:text-lg font-semibold text-white backdrop-blur transition hover:-translate-y-0.5 hover:border-white/30 hover:bg-white/15"
            >
              Konteynerimi Sat
              <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5 shrink-0 opacity-70" />
            </Link>
