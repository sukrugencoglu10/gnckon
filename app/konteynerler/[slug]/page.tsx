        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 inline-flex items-center gap-2 rounded-lg bg-wa/10 px-4 py-2 text-base font-bold text-wa-dark">
              ...
              <div className="mt-5 flex flex-col gap-2 sm:flex-row">
                <a
                  ...
                  className="group relative inline-flex flex-1 items-center justify-center gap-2.5 overflow-hidden whitespace-nowrap rounded-xl bg-wa px-5 py-3.5 text-base font-bold text-white shadow-lg shadow-wa/25 transition hover:-translate-y-0.5 hover:bg-wa-dark hover:shadow-xl hover:shadow-wa/35"
                >
                ...
                <a
                  href={telLink()}
                  className="inline-flex flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl border-2 border-brand-600 bg-white px-5 py-3 text-base font-bold text-brand-600 shadow-sm transition hover:-translate-y-0.5 hover:bg-brand-50 hover:shadow-md"
                >
                  <Phone className="h-4 w-4" /> Hemen Ara
                </a>
              </div>

              <p className="mt-6 leading-relaxed text-ink-700">{c.description}</p>

              <h2 className="mt-8 text-lg font-bold text-ink-900">Teknik Özellikler</h2>
              <dl className="mt-3 grid grid-cols-1 overflow-hidden rounded-xl ring-1 ring-black/5 sm:grid-cols-2">
                {Object.entries(c.specs).map(([k, v], i) => (
                  <div
                    key={k}
                    className={`flex justify-between gap-4 bg-white px-4 py-3 text-sm ${
