...
export async function POST(req: Request) {
  try {
    ...
    const scriptUrl = process.env.APPS_SCRIPT_URL || "https://script.google.com/macros/s/AKfycbzLskFSGdVXFK6u6MzDQ5tJrTmpBb5TK5HdfwyDJjHF4DrNhXxOLnNK5kMje1Ffp_6Oow/exec";
