    ...
    <>
      ...
      <section className="container-x py-10 lg:py-14">
        <div className="prose prose-neutral max-w-3xl">
          <p>
            <b>{site.legalName}</b>, Türkiye'nin önde gelen konteyner alım-satım ve modifikasyon firmasıdır.
            Liman çıkışı yeni konteynerlerden, bakımlı ikinci el ürünlere; soğutuculu reefer ünitelerinden
            açık platform flat rack konteynerlere kadar geniş bir stokla hizmet veriyoruz.
          </p>
          <p>
            Misyonumuz, müşterilerimize <b>hızlı yanıt</b>, <b>şeffaf fiyat</b> ve <b>garantili teslimat</b>
            sağlamaktır. Tüm satışlarımız faturalı, kontrol edilmiş ve sertifikalıdır.
          </p>
